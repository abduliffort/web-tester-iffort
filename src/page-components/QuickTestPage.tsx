  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-purple-50 flex items-center justify-center p-4">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Quick Test</h1>
        <p className="text-lg text-gray-600 mb-8">
          Test your download speed, upload speed, and latency in under 3 minutes
        </p>
        <button
          onClick={startTest}
          className="px-8 py-4 bg-blue-600 text-white text-lg font-semibold rounded-full hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl"
        >
          Start Quick Test
        </button>
      </div>
        ...
        progressMetrics={
          testStatus === "in-progress"
            ? [
                ...
                { label: "Latency", value: "00", unit: "ms" },
              ]
            : undefined
        }

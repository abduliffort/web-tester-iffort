...
import type { TestModalProps, TestModalHandle } from "./TestModal.types";
...
import { Download, House, Info, RotateCw, X } from "lucide-react";
...
export const TestModal = forwardRef<TestModalHandle, TestModalProps>(
  (
    {
      isOpen,
      onClose,
            ...
            <div className="">
              ...
              <div className="flex flex-col items-center w-full max-sm:mb-[3rem] mb-[3rem]">
                ...
                {(isRunning || isInitializing) && (
                  <div className="w-full">
                    <div
                      className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${currentDisplay === ENV_CONFIG.SCENARIOS.FULL_TEST_ID
                        ? `items-center gap-[5rem] max-sm:gap-[3.5rem] ${!isInitializing && "mt-12"
                        }`
                        : ""
                        }`}
                    >
            ...
            <div className="flex justify-center gap-2">
              {!results && isRunning && (
                <button
                  ...
                  className="justify-center text-[0.9rem] gap-2 px-4 font-semibold flex border border-darkYellow hover:text-gray-600 dark:hover:text-gray-300 transition-colors p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"
                  aria-label={
                    results && !isRunning ? "Export Result" : "Stop Test"
                  }
                >
